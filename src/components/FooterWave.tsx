...
/**
 * The footer's water line, generated from superposed cosines:
 *
...
// amplitude, wavelength, angular speed (rad/s — negative travels the other way)
...
export function FooterWave() {
  ...
  useEffect(() => {
    ...
    // Measure on scroll/resize only — reading layout every frame would thrash.
    const measure = () => {
  ...
  return (
    <div className="site-footer__wave" ref={wrapRef} aria-hidden="true">
